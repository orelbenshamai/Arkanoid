...
/**
 * this class implements level four in our game.
 *
...
public class LevelFour implements LevelInformation {
    ...
    private static final Point START_OF_BLOCKS = new Point(300, 120);
    ...
    private static final Point SECOND_BALL_POSITION = new Point(390, 400);
    private static final Point THIRD_BALL_POSITION = new Point(480, 400);
    ...
    public List<Point> ballsPositions() {
        ...
        positions.add(THIRD_BALL_POSITION);
        return positions;
    }
    ...
    public Sprite getBackground() {
        ...
        Block background = new Block(new Rectangle(point, WIDTH - DEPTH, WIDTH - DEPTH), Color.blue);
        return background;
    }
    ...
    public List<Block> blocks() {
        ...
        Color[] rowColor = {Color.GRAY, Color.RED, Color.YELLOW, Color.GREEN, Color.WHITE, Color.pink};
        double startY = START_OF_BLOCKS.getY();
        for (int i = 0; i < ROWS_OF_BLOCKS; i++) {
            for (int j = 0; j < NUM_OF_BLOCKS; j++) {
                Point p = new Point(25 + (BLOCK_WIDTH * j), startY);
